...
`,h=e=>{let{bTokens:t=[]}=e;const a=360/t.length;return Object(x.jsxs)(u,{className:"v3-tokens",children:[Object(x.jsx)("div",{className:"tokens",children:t.filter(((e,t)=>t<3)).map(((e,t)=>Object(x.jsx)("div",{className:"base-token-box-bg",children:Object(x.jsx)("div",{className:`base-token-bg ${e.bTokenSymbol}`})},t)))}),Object(x.jsxs)("div",{className:"base-token-box-bg explode",children:[Object(x.jsxs)("div",{className:"base-token-bg num-token",children:[t.length-3," +"]}),t.map(((e,t)=>{const s=a*t;return Object(x.jsx)(p,{className:"base-token",rotate:s,width:"100",children:Object(x.jsx)("div",{width:"100",rotate:s,className:`base-token-bg move ${e.bTokenSymbol}`})},t)}))]})]})}},2180:function(e,t,a){}}]);
//# sourceMappingURL=8.0c1c8e59.chunk.js.map